...
MainFrameBase::MainFrameBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
    ...
    this->SetSize(wxSize(dpiz(390), dpiz(340)));
	...
	bSizer4->Add( m_staticText3, 0, wxALL|wxALIGN_LEFT, 5 );
	...
	bSizer4->Add( m_textCtrl1, 0, wxEXPAND|wxALIGN_LEFT, 5 );
	...
	bSizer4->Add( m_staticText4, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_LEFT, 5 );
	...
	bSizer4->Add( m_textCtrl2, 0, wxEXPAND|wxALIGN_LEFT, 5 );
	...
	bSizer4->Add( m_radioBtn1, 0, wxALIGN_CENTER_VERTICAL|wxALL|wxALIGN_LEFT, 5 );
	...
	bSizer6->Add( m_staticText5, 0, wxALL|wxALIGN_LEFT, 5 );
	...
	bSizer6->Add( m_textCtrl3, 0, wxEXPAND|wxALIGN_LEFT, 5 );
	...
	bSizer6->Add( m_staticText6, 0, wxALL|wxALIGN_CENTER_VERTICAL|wxALIGN_LEFT, 5 );
	...
	bSizer7->Add( m_button1, 0, wxLEFT|wxALIGN_LEFT, 5 );
	
	
	bSizer7->Add( 0, 0, 1, wxEXPAND, 5 );
	
	m_button2 = new wxButton( m_panel1, wxID_ANY, _("?"), wxDefaultPosition, wxSize(dpiz(122), -1), 0 );
	bSizer7->Add( m_button2, 0, wxRIGHT|wxALIGN_RIGHT, 5 );
	...
	bSizer8->Add( m_staticText7, 0, wxLEFT|wxALIGN_LEFT, 5 );
	
	m_staticText8 = new wxStaticText( m_panel1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(dpiz(122), -1), 0);
	...
	bSizer8->Add( m_staticText8, 0, wxRIGHT|wxALIGN_RIGHT, 5 );
	...
	bSizer9->Add( m_staticText9, 0, wxLEFT|wxALIGN_LEFT, 5 );
	
	m_staticText10 = new wxStaticText( m_panel1, wxID_ANY, wxEmptyString, wxDefaultPosition, wxSize(dpiz(122), -1), 0);
	...
	bSizer9->Add( m_staticText10, 0, wxRIGHT|wxALIGN_RIGHT, 5 );
	...
	bSizer1->Add( m_panel1, 1, wxEXPAND|wxALL|wxALIGN_CENTER_HORIZONTAL, 5 );
